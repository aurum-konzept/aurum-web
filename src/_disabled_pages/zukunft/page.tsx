        ...
        <div className="relative z-10">
           <Header />
            ...
            <section className="mx-auto max-w-6xl px-6 py-16">
                ...
                <p className="mt-6 max-w-3xl text-neutral-300 md:text-lg">
                ...
                {[
                    ...
                    <div key={t} className="rounded-3xl border border-neutral-800 p-6">
            ...
            <section>
                ...
                <h2 className="text-2xl font-semibold">1) Geplante Verwahrungsleistung</h2>
            ...
            <section>
                <div className="mx-auto max-w-6xl px-6 py-14">
                <h2 className="text-2xl font-semibold">2) Online-Übersicht der Verwahrsumme</h2>
                <p className="mt-4 max-w-3xl text-neutral-300">
                ...
                <div className="mt-6 rounded-3xl border border-neutral-800 p-6">
            ...
            <section>
                <div className="mx-auto max-w-6xl px-6 py-14">
                <h2 className="text-2xl font-semibold">3) Netzwerk für Verkäufe (Liquidation)</h2>
                <p className="mt-4 max-w-3xl text-neutral-300">
                    Ein großes Ziel ist der Aufbau eines Netzwerks aus Ankäufern, um private
            ...
            <section>
                <div className="mx-auto max-w-6xl px-6 py-14">
                <h2 className="text-2xl font-semibold">4) Edelmetalle nutzen statt verkaufen</h2>
                <p className="mt-4 max-w-3xl text-neutral-300">
            ...
            <footer className="py-10">
                ...
                © {new Date().getFullYear()} Aurum · <a className="hover:text-white" href="/#kontakt">Kontakt</a>
                </div>
            </footer>
        </div>
    </main>
